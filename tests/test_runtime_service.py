...
def fake_pipeline(*, source_text: str, mode: str, query: str, surface_mode: str, candidate_count: int, use_xai_judge: bool):
    generated = {
    ...
    scored = generated["candidates"]
    return generated, scored, {"winner": 9.0} if use_xai_judge else {}
...
class RuntimeServiceTests(unittest.TestCase):
    ...
    @patch("runtime.service._legacy_api_run", side_effect=fake_pipeline)
    def test_submit_rewrite_persists_job_and_candidates(self, _fake_pipeline) -> None:
    ...
    @patch("runtime.service._legacy_api_run", side_effect=fake_pipeline)
    def test_choose_candidate_updates_job(self, _fake_pipeline) -> None:
        result = service.submit_rewrite(
            {
                "text": "hello world",
                "mode": "casual_us_human_mode",
    ...
    @patch("runtime.service._legacy_api_run", side_effect=fake_pipeline)
    def test_idempotency_same_request_returns_same_job(self, _fake_pipeline) -> None:
        payload = {
            "text": "hello world",
            "mode": "casual_us_human_mode",
            "surface_mode": "reply",
    ...
    @patch("runtime.service._legacy_api_run", side_effect=fake_pipeline)
    def test_idempotency_conflict_raises(self, _fake_pipeline) -> None:
        first_payload = {
            "text": "hello world",
            "mode": "casual_us_human_mode",
            "surface_mode": "reply",
